          ...
          >
            <Avatar className="h-32 w-32 md:w-48 md:h-48 rounded-full overflow-hidden">
              {image ? (
                ...
                <div
                  className={`uppercase h-32 w-32 md:w-48 md:h-48 flex items-center justify-center text-5xl border-[1px] border-gray-300 rounded-full ${getColor(
                    selectedColor
                  )}`}
                >
            ...
            {hovered && (
              <div className="absolute inset-0 flex items-center justify-center bg-black opacity-50 rounded-full cursor-pointer"
